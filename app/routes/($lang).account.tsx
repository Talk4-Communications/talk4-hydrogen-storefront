import {Link, Outlet, useLoaderData, useMatches, useOutlet} from "@remix-run/react";
            ...
            {isAuthenticated &&
                <div className="flex h-screen ">
                    <div className="basis-1/6 bg-white">
                        <div className="flex max-h-screen flex-col items-center justify-center space-y-3">
                            <div className="m-7">
                            ...
                            <div className="flex-1 w-full">
                                <ul className="py-4 space-y-2 text-sm font-medium font-gt-pro">
                                    ...
                                    <li className="rounded-sm pl-3 pb-3 pt-3 hover:bg-offwhite">
                                        <a
                                            href="/account/SwitchProvers"
                                            className="flex items-center p-2 space-x-3 rounded-sm hover:border-r-2 hover:border-pink hover:text-pink hover:fill-pink"
                                        >
                                            <svg className="w-5 h-5" viewBox="0 0 20 18" >
                                                <path xmlns="http://www.w3.org/2000/svg" d="M14.8396 2.796C15.2193 2.796 15.5331 3.07816 15.5828 3.44423L15.5896 3.546L15.5895 15.346L18.3857 12.5386C18.6779 12.245 19.1528 12.2439 19.4464 12.5361C19.7133 12.8018 19.7384 13.2184 19.5213 13.5125L19.4488 13.5968L15.371 17.6934C15.3465 17.7176 15.3215 17.7395 15.2951 17.7597L15.371 17.6934C15.3343 17.7304 15.2946 17.7627 15.2527 17.7904C15.2381 17.7995 15.2229 17.8088 15.2074 17.8175C15.193 17.8262 15.1784 17.8338 15.1635 17.841C15.1489 17.8474 15.134 17.854 15.1189 17.86C15.0998 17.8682 15.0801 17.8752 15.0602 17.8813C15.0485 17.8844 15.0365 17.8878 15.0244 17.8909C15.0028 17.8968 14.981 17.9013 14.9592 17.9048C14.949 17.9059 14.9383 17.9074 14.9275 17.9087C14.9029 17.9121 14.8784 17.9137 14.854 17.9142C14.8492 17.9137 14.8444 17.9138 14.8396 17.9138L14.825 17.9142C14.8006 17.9137 14.7761 17.9121 14.7518 17.9092L14.8396 17.9138C14.7987 17.9138 14.7587 17.9105 14.7196 17.9042C14.6979 17.9013 14.6762 17.8968 14.6547 17.8913C14.6434 17.8879 14.632 17.8848 14.6207 17.8813C14.5992 17.8753 14.5778 17.8678 14.5568 17.8592C14.5452 17.8539 14.5341 17.8491 14.5231 17.8439C14.5059 17.8366 14.4886 17.8277 14.4715 17.8181C14.4562 17.8087 14.441 17.7995 14.4263 17.7897C14.4147 17.7828 14.4034 17.7748 14.3922 17.7665L14.3842 17.7597C14.3578 17.7395 14.3327 17.7176 14.3093 17.6941L14.3079 17.6934L10.2302 13.5968C9.93795 13.3032 9.93904 12.8283 10.2326 12.5361C10.4995 12.2705 10.9162 12.2472 11.2093 12.4658L11.2933 12.5386L14.0895 15.348L14.0896 3.546C14.0896 3.13179 14.4254 2.796 14.8396 2.796ZM4.91116 0.0824475L4.92577 0.0820312C4.95021 0.0825008 4.97463 0.0841578 4.99894 0.0870022L4.91116 0.0824475C4.95202 0.0824475 4.99212 0.0857147 5.0312 0.0920019C5.05258 0.0949236 5.07404 0.0993396 5.0953 0.104701C5.10781 0.10837 5.12056 0.111948 5.13317 0.115849C5.15286 0.121401 5.17192 0.12815 5.19073 0.135691C5.20434 0.141748 5.21811 0.147768 5.23166 0.154182C5.24777 0.161145 5.26363 0.16934 5.27924 0.178138C5.29261 0.186368 5.30584 0.194386 5.3188 0.202794C5.33214 0.210723 5.34549 0.220002 5.3586 0.229765L5.44283 0.302789L9.52061 4.39946C9.81282 4.69302 9.81172 5.1679 9.51816 5.46011C9.25127 5.72576 8.83455 5.74901 8.54145 5.53047L8.4575 5.45766L5.6605 2.64703L5.66116 14.4502C5.66116 14.8644 5.32538 15.2002 4.91116 15.2002C4.53147 15.2002 4.21767 14.9181 4.16801 14.552L4.16116 14.4502L4.1605 2.64803L1.36505 5.45766C1.0994 5.72454 0.682793 5.74971 0.388679 5.53254L0.304393 5.46011C0.0375118 5.19446 0.012343 4.77786 0.229518 4.48374L0.301942 4.39946L4.37972 0.302789L4.42388 0.262292C4.43425 0.25342 4.44487 0.244826 4.45572 0.236522L4.37972 0.302789C4.41651 0.265827 4.45619 0.233504 4.49804 0.205819C4.51264 0.196723 4.52782 0.187436 4.54334 0.178686C4.55775 0.170002 4.57239 0.162382 4.58723 0.155278C4.60187 0.148796 4.61673 0.142255 4.63183 0.136192C4.65101 0.127989 4.67069 0.121044 4.69057 0.114943C4.70266 0.111695 4.71505 0.108232 4.72756 0.105084C4.74771 0.0995502 4.76808 0.0953195 4.78856 0.0919409C4.80087 0.0904003 4.81294 0.0887204 4.8251 0.0873313C4.84826 0.0841507 4.87201 0.0825393 4.89578 0.0820511C4.90102 0.082498 4.90609 0.0824475 4.91116 0.0824475Z" />
                                            </svg>
